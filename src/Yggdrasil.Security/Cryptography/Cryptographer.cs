...
{
    private readonly ICryptographicAlgorithmProvider _algorithmProvider;

    public Cryptographer(ICryptographicAlgorithmProvider algorithmProvider)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        using var algorithm = _algorithmProvider.CreateSymmetricAlgorithm(key, salt, iterations);
